        ...
        <div class="col-md-12">
            <marquee behavior="scroll" direction="left" id="myMarquee">
                <ul>
                    ...
                    <li>
                        <a>{{$application_event[0]->title}} for the year {{$application_event[0]->application_year}} are open from {{ \Carbon\Carbon::parse($application_event[0]->open_date)->format('d-m-y') }} to {{ \Carbon\Carbon::parse($application_event[0]->close_date)->format('d-m-y') }}
                        </a>
                    </li>
                    @endif
                    @if($scholarship_event->count() >0)
                    <li>
                        <a>{{$scholarship_event[0]->title}} for the year {{$scholarship_event[0]->application_year}} are open from {{ \Carbon\Carbon::parse($scholarship_event[0]->open_date)->format('d-m-y') }} to {{ \Carbon\Carbon::parse($scholarship_event[0]->close_date)->format('d-m-y') }} </a>
                    </li>
                    @endif
                </ul>
            </marquee>
        ...
        <div class="row align-items-center">
            <div class="col-lg-9 col-md-8 col-sm-12">
                <div class="cta-content">
                    ...
                    <p>LogIn to apply for Admission and Scholarship applications.</p>
                </div>
            </div>
