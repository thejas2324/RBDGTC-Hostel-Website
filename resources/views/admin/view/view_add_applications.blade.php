                        ...
                        htmldata += `<tr>
                                        ...
                                        <td>
                                            <h6 class="mb-0 text-center">
                                                <a style="margin-right: 10px;" href="/selectreject/${result[i].application_id}/Approved"><i class="fa-solid fa-circle-check fa-2xl" data-toggle="tooltip" data-placement="top" title="Approve" style="color: #6ac81e;"></i></a>
                                                <a href="/selectreject/${result[i].application_id}/Rejected"><i class="fa-solid fa-circle-xmark fa-2xl" data-toggle="tooltip" data-placement="top" title="Reject" style="color: #db1f1f;"></i></a>
                                            </h6>
                                        </td>
