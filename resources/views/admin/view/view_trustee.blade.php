    ...
    function confirmDelete(id, trustee_name) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                location.href = "/deletetrustee/" + id;
                Swal.fire(
                    'Deleted!',
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-title flex-wrap">
                            <h2 class="mt-1">Our present trustees details</h2>
                            <div>
                                <a href="/addtrustee" type="button" class="btn btn-primary">
                                    + New Trustee
                                </a>
                            </div>
                        </div>
                            ...
                            <table id="example" class="table-responsive-lg table display dataTablesCard student-tab dataTable no-footer">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="date">{{$vi->email_id}}</div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <h6 class="mb-0">{{$vi->trustee_status}}</h6>
                                        </td>
                                        <td class="text-center">
                                            <a data-bs-toggle="modal" data-bs-target="#trustee_edit{{$vi->id}}"><i class="fa-solid fa-user-pen fa-lg" style="color: #5cb955;"></i></a>
                                        </td>
                                    ...
                                    <div class="modal fade" id="trustee_edit{{$vi->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
