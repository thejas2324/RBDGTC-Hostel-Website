                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="page-title flex-wrap">
                            <h2 class="mt-1">Selected Admission Applications ({{count($selectedapplications)}})</h2>
                        </div>
                    </div>
                    <!-- filter -->
                    <div class="row">
                                    ...
                                    <tr>
                                        <!-- <td>
                                            <div class="trans-list">
                                                <img src="/admissions/applicant_images/{{$selectedapplication->applicant_image}}" alt="" class="avatar avatar-sm me-3">
                                                <h4></h4>
                                            </div>
                                        </td> -->
                                        <td><span class="text-primary font-w600">{{$selectedapplication->application_id}}</span></td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->applying_hostel}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->applicant_name}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->gender}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->puc_diploma_marks}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->ug_marks}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->dependent_status}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->disability_status}}</h6>
                                        </td>
                                        <td>
                                            <h6 class="mb-0">
                                        ...
                                        <td>
                                            <h6 class="mb-0">{{$selectedapplication->action_taken_by}}</h6>
                                        </td>
                                        <td class="text-center">
                                            <a href="#" onclick="edit_application('{{$selectedapplication->application_id}}')">
                                                <i class="fa-solid fa-pen-to-square fa-lg" style="color: #32912b;"></i>
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <a href="/adminprintadmission/{{$selectedapplication->s_id}}" class="btn btn-success"><i class="fa-solid fa-print fa-lg"></i> Print</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
