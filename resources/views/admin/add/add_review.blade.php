                                ...
                                <div class="col-xl-3 col-lg-4">
                                    ...
                                    <div class="avatar-upload">
                                        ...
                                        <div class="change-btn mt-2 mb-lg-0 mb-3">
                                            <input type="file" class="form-control d-none" id="imageUpload" name="image" class="required" accept=".png, .jpg, .jpeg" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="fullname" class="form-control" id="exampleFormControlInput1" placeholder="Full Name" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="quali" class="form-control" id="exampleFormControlInput1" placeholder="Qualification" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="year" class="form-control" id="exampleFormControlInput1" placeholder="ex: 2021-2023" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="msg1" class="form-control" id="" cols="30" rows="5" placeholder="message 1" required></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label text-primary">Enter message2<span></span></label>
                                                <textarea name="msg2" class="form-control" id="" cols="30" rows="5" placeholder="message 2" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="">
