                                ...
                                <div class="col-xl-3 col-lg-4">
                                    ...
                                    <div class="avatar-upload">
                                        ...
                                        <div class="change-btn mt-2 mb-lg-0 mb-3">
                                            <input type="file" class="form-control d-none" id="imageUpload" name="image" accept=".png, .jpg, .jpeg" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="mail" name="email" class="form-control" id="exampleFormControlInput1" placeholder="abc@gmail.com" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label for="exampleFormControlInput1" class="form-label text-primary">Designation<span class="required">*</span></label>
                                                <input type="mail" name="designation" class="form-control" id="exampleFormControlInput1" placeholder="designation" required>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-5">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" name="fdate" class="form-control" id="fromdate" required>
                                            </div>
                                        </div>
                                        <div class="col-md-5" id="toDateColumn">
                                            <div class="mb-3">
                                                <label for="todate" class="form-label text-primary">To Date<span></span></label>
                                                <input type="date" name="tdate" class="form-control" id="todate" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
